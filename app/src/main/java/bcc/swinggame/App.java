...
public class Snake {
  ...
  static final int SCREEN_SIZE_Y = 30; //screen dimensions
  
  final int MAX_SNAKE_LENGTH = 1000; //max length of the snake
  ...
  int dirX = -1; 
  int dirY = 0; //direction of the snake
  
  Color color; // color of snake
